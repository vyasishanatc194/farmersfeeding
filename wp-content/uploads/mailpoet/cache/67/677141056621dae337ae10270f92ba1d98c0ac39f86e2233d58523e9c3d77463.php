...
class __TwigTemplate_44e0a5d5b23dc4297a30b4d631ef02d9a8a59deed8b6cdc0faf596ce873dcec0 extends \MailPoetVendor\Twig\Template
{
  ...
  <tbody>
      ...
      <td>
        <p>
          <input type=\"text\"
            ...
            value=\"";
        // line 31
        echo \MailPoetVendor\twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "notification", []), "address", []), "html", null, true);
        echo "\"
        ...
        <p>
          <label for=\"settings[notification_on_subscribe]\">
            ...
            ";
        // line 40
        if ($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "notification", []), "on_subscribe", [])) {
        ...
        <p>
          <label for=\"settings[notification_on_unsubscribe]\">
            ...
            ";
        // line 50
        if ($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "notification", []), "on_unsubscribe", [])) {
            echo "checked=\"checked\"";
        }
        echo " />
            ";
      ...
      <td>
        <p>
          <input
            ...
            ";
        // line 74
        if ($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "subscribe", []), "on_comment", []), "enabled", [])) {
            echo "checked=\"checked\"";
        }
        // line 75
        echo "          />
        ...
        <div id=\"mailpoet_subscribe_on_comment\">
          <p>
            <input
              ...
              ";
        // line 84
        if ($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "subscribe", []), "on_comment", []), "label", [])) {
            // line 85
            echo "                  value=\"";
            echo \MailPoetVendor\twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "subscribe", []), "on_comment", []), "label", []), "html", null, true);
            echo "\"
              ";
        } else {
            // line 87
        ...
        $context['_seq'] = \MailPoetVendor\twig_ensure_traversable((isset($context["segments"]) ? $context["segments"] : null));
        foreach ($context['_seq'] as $context["_key"] => $context["segment"]) {
            ...
            echo "\"
                  ";
            // line 104
            if (\MailPoetVendor\twig_in_filter($this->getAttribute($context["segment"], "id", []), $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "subscribe", []), "on_comment", []), "segments", []))) {
                // line 105
    ...
    <tr>
      ...
      <td>
        ";
        // line 125
        if (($this->getAttribute((isset($context["flags"]) ? $context["flags"] : null), "registration_enabled", []) == true)) {
            // line 126
            echo "          <p>
            <input
              ...
              ";
            // line 133
            if ($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "subscribe", []), "on_register", []), "enabled", [])) {
                // line 134
                echo "                checked=\"checked\"
              ";
            }
          ...
          <div id=\"mailpoet_subscribe_in_form\">
            <p>
              <input
                ...
                ";
            // line 146
            if ($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "subscribe", []), "on_register", []), "label", [])) {
                // line 147
                echo "                  value=\"";
                echo \MailPoetVendor\twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "subscribe", []), "on_register", []), "label", []), "html", null, true);
                echo "\"
                ";
            } else {
                // line 149
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["segment"]) {
                ...
                echo "\"
                    ";
                // line 166
                if (\MailPoetVendor\twig_in_filter($this->getAttribute($context["segment"], "id", []), $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "subscribe", []), "on_register", []), "segments", []))) {
                    // line 167
                    echo "                      selected=\"selected\"
                    ";
                }
    ...
    <tr>
      ...
      <td>
        ...
        // line 200
        $context['_parent'] = $context;
        $context['_seq'] = \MailPoetVendor\twig_ensure_traversable((isset($context["pages"]) ? $context["pages"] : null));
        foreach ($context['_seq'] as $context["_key"] => $context["page"]) {
            ...
            echo "\"
                ";
            // line 204
            if (($this->getAttribute($context["page"], "id", []) == $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "subscription", []), "pages", []), "manage", []))) {
                // line 205
                echo "                  selected=\"selected\"
                ";
            }
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["segment"]) {
            ...
            echo "\"
                ";
            // line 230
            if (\MailPoetVendor\twig_in_filter($this->getAttribute($context["segment"], "id", []), $this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "subscription", []), "segments", []))) {
                // line 231
                echo "                  selected=\"selected\"
                ";
            }
      ...
      <td>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["page"]) {
            ...
            echo "\"
                ";
            // line 262
            if (($this->getAttribute($context["page"], "id", []) == $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "subscription", []), "pages", []), "unsubscribe", []))) {
                // line 263
                echo "                  selected=\"selected\"
                ";
            }
      ...
      <td>
        <p>
          <label>
            <input
              ...
              ";
        // line 293
        if ($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "stats_notifications", []), "enabled", [])) {
            // line 294
            echo "                checked
              ";
        }
        ...
        echo "
          ...
          <input type=\"email\"
            ...
            value=\"";
        // line 313
        echo \MailPoetVendor\twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "stats_notifications", []), "address", []), "html", null, true);
        echo "\"
      ...
      <td>
        <p>
          <label>
            ...
            ";
        // line 335
        if ($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "subscriber_email_notification", []), "enabled", [])) {
            // line 336
            echo "            checked
            ";
        }
        ...
        echo "
          ...
          <input type=\"email\"
                 ...
                 value=\"";
        // line 355
        echo \MailPoetVendor\twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "subscriber_email_notification", []), "address", []), "html", null, true);
        echo "\"
                 placeholder=\"me@mydomain.com\" />
          <br>
...
";
    ...
    {
        return new Source("", "settings/basics.html", "/data03/c5882760/public_html/wp-content/plugins/mailpoet/views/settings/basics.html");
    }
}
