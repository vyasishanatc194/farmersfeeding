...
/* settings.html */
class __TwigTemplate_76741233342633b798b4046098d6ff0999a235e92233cdd2cdf3dec2ac8a6208 extends \MailPoetVendor\Twig\Template
{
  ...
  <script type=\"text/javascript\">
    ...
    var mailpoet_settings_signup_confirmation_name = \"";
        // line 252
        echo \MailPoetVendor\twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute(($context["settings"] ?? null), "signup_confirmation", []), "from", []), "name", []), "html", null, true);
        echo "\";
    var mailpoet_settings_signup_confirmation_address = \"";
        // line 253
        echo \MailPoetVendor\twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute(($context["settings"] ?? null), "signup_confirmation", []), "from", []), "address", []), "html", null, true);
        echo "\";
...
";
    ...
    {
        return new Source("", "settings.html", "/var/www/html/dev/wordpress/liberty_cremations/wp-content/plugins/mailpoet/views/settings.html");
    }
}
