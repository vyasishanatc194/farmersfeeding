...
class __TwigTemplate_e56f7e34c49b014de0ec987a68703a913ccbdc95427dfb045ef522cc368ab1ba extends \MailPoetVendor\Twig\Template
{
...
(isset($context["subscriber_email"]) ? $context["subscriber_email"] : null), "%\$2s" => (isset($context["segments_names"]) ? $context["segments_names"] : null)]), "html", null, true);
        // line 5
        echo "
...
(isset($context["link_settings"]) ? $context["link_settings"] : null)));
        // line 13
        echo "</small>
...
(isset($context["link_premium"]) ? $context["link_premium"] : null)));
            // line 21
            echo "
  </small>
";
    ...
    {
        return new Source("", "emails/newSubscriberNotification.html", "/data03/c5882760/public_html/wp-content/plugins/mailpoet/views/emails/newSubscriberNotification.html");
    }
}
