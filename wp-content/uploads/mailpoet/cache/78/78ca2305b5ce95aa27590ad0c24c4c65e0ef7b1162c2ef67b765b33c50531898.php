...
class __TwigTemplate_9d3c1b474240357b9608470bcac1af839d0255f01f8bb6f620ed80cf18222caa extends \MailPoetVendor\Twig\Template
{
      ...
      <td>
        <p>
          <input type=\"text\"
            ...
            value=\"";
        // line 22
        echo \MailPoetVendor\twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "bounce", []), "address", []), "html", null, true);
        echo "\"
    ...
    <tr>
      ...
      <td>
        <p>
          <label>
            <input
              ...
              value=\"";
        // line 47
        echo \MailPoetVendor\twig_escape_filter($this->env, $this->getAttribute((isset($context["cron_trigger"]) ? $context["cron_trigger"] : null), "wordpress", []), "html", null, true);
        echo "\"
              data-automation-id=\"wordress_cron_radio\"
              ";
        // line 49
        if (($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "cron_trigger", []), "method", []) == $this->getAttribute((isset($context["cron_trigger"]) ? $context["cron_trigger"] : null), "wordpress", []))) {
            // line 50
        ...
        <p>
          <label>
            <input
              ...
              value=\"";
        // line 60
        echo \MailPoetVendor\twig_escape_filter($this->env, $this->getAttribute((isset($context["cron_trigger"]) ? $context["cron_trigger"] : null), "mailpoet", []), "html", null, true);
        echo "\"
              data-automation-id=\"mailpoet_cron_radio\"
              ";
        // line 62
        if (($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "cron_trigger", []), "method", []) == $this->getAttribute((isset($context["cron_trigger"]) ? $context["cron_trigger"] : null), "mailpoet", []))) {
            // line 63
            echo "                checked=\"checked\"
                ";
        }
        ...
        echo "\"
            ...
            ";
        // line 78
        if (($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "cron_trigger", []), "method", []) == $this->getAttribute((isset($context["cron_trigger"]) ? $context["cron_trigger"] : null), "linux_cron", []))) {
            // line 79
            echo "            checked=\"checked\"
            ";
        }
        ...
        echo "<br>
            <input
               value=\"php ";
        // line 89
        echo \MailPoetVendor\twig_escape_filter($this->env, (isset($context["linux_cron_path"]) ? $context["linux_cron_path"] : null), "html", null, true);
        echo "/mailpoet-cron.php ";
        echo \MailPoetVendor\twig_escape_filter($this->env, (isset($context["ABSPATH"]) ? $context["ABSPATH"] : null), "html", null, true);
        echo "\"
               class=\"large-text\"
               readonly
            />
        ...
        <p>
          <label>
            <input
              ...
              ";
        // line 142
        if ($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "tracking", []), "enabled", [])) {
            // line 143
            echo "              checked=\"checked\"
              ";
        }
        ...
        <p>
          <label>
            <input
              ...
              ";
        // line 192
        if ( !$this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "deactivate_subscriber_after_inactive_days", [])) {
            echo "checked=\"checked\"";
        }
        // line 193
        echo "            />";
        ...
        <p>
          <label>
            <input
              ...
              ";
        // line 202
        if (($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "deactivate_subscriber_after_inactive_days", []) == 90)) {
            echo "checked=\"checked\"";
        }
        // line 203
        echo "            />";
        ...
        <p>
          <label>
            <input
              ...
              ";
        // line 213
        if (($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "deactivate_subscriber_after_inactive_days", []) == 180)) {
            echo "checked=\"checked\"";
        }
        // line 214
        echo "            />";
        ...
        <p>
          <label>
            <input
              ...
              ";
        // line 223
        if (($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "deactivate_subscriber_after_inactive_days", []) == 365)) {
            echo "checked=\"checked\"";
        }
        // line 224
        echo "            />";
        ...
        <p>
          <label>
            <input
              ...
              ";
        // line 251
        if ($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "analytics", []), "enabled", [])) {
            // line 252
            echo "                checked=\"checked\"
              ";
        }
        ...
        <p>
          <label>
            <input
              ...
              ";
        // line 292
        if ($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "re_captcha", []), "enabled", [])) {
            // line 293
            echo "                checked=\"checked\"
              ";
        }
        ...
        <div id=\"settings_re_captcha_tokens\">
          <p>
            <input type=\"text\"
              ...
              value=\"";
        // line 313
        echo \MailPoetVendor\twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "re_captcha", []), "site_token", []), "html", null, true);
        echo "\"
              placeholder=\"";
        // line 314
        ...
        echo "\"
          ...
          <p>
            <input type=\"text\"
              ...
              value=\"";
        // line 321
        echo \MailPoetVendor\twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "re_captcha", []), "secret_token", []), "html", null, true);
        echo "\"
              placeholder=\"";
        // line 322
      ...
      <td>
        ...
        >
          <option
            ...
            ";
        // line 363
        if (($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "logging", []) == "everything")) {
            // line 364
            echo "              selected
            ";
        }
        ...
        echo "
          <option
            ...
            ";
        // line 370
        if ((($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "logging", []) != "nothing") && ($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "logging", []) != "everything"))) {
            // line 371
            echo "              selected
            ";
        }
        ...
        echo "
          <option
            ...
            ";
        // line 377
        if (($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "logging", []) == "nothing")) {
            // line 378
            echo "              selected
            ";
        }
